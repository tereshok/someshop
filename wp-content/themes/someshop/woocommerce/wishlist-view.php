...
<table
	...
	<tr>
		...
		<th class="product-thumbnail">
			<span class="nobr">
				<?php echo esc_html( apply_filters( 'yith_wcwl_wishlist_view_thumbnail_heading', __( 'Product thumbnail', 'yith-woocommerce-wishlist' ), $wishlist ) ); ?>
			</span>
		</th>
		...
		<?php if ( $show_last_column ) : ?>
			...
			<th class="product-add-to-cart">
				<span class="nobr">
					<?php echo esc_html( apply_filters( 'yith_wcwl_wishlist_view_cart_heading', __( 'Add to cart', 'yith-woocommerce-wishlist' ), $wishlist ) ); ?>
				</span>
			</th>
		<?php endif; ?>
